...
dominio="OU=Formacion Profesional,DC=efrain,DC=com";
...
print "dsadd user -upn "usuario"@efrain.com \"CN="nombreordenado","unidad"\" -samid "usuario" -disabled no -pwd $M"clave"a# -mustchpwd yes -memberof \""grupo"\" -fn \""nombre"\" -ln \""apellido1" "apellido2"\" -display \""nombrecompleto"\" -q" > fichero
